...
ADMINS = (
    # ('IsaacMusyoka', 'musyokaisaac98@gmail.com'),
)
MANAGERS = ADMINS
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://isaac:morzy@localhost:5432/saleortest',
        conn_max_age=600)}
...
ALLOWED_HOSTS = get_list(
    os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1','saleord.herokuapp.com'))
